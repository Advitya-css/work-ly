...
4. CRITICAL: "requiredSkills" and "preferredSkills" MUST be atomic technologies, tools, methodologies, or core competencies (e.g. "React", "Docker", "Customer Service", "Point of Sale", "Inventory Management"). DO NOT extract full sentences or vague phrases. Break down complex requirements into the specific, short keywords a recruiter would search for.
