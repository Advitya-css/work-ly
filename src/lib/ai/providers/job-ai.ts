...
4. "requiredSkills" and "preferredSkills" are short, flat skill/technology names only (e.g. "React", "SQL", "stakeholder management") pulled from the requirements: not full sentences.
