...
5b. Write every date as "YYYY-MM" when the resume gives a month, or "YYYY" when it gives only a year - never add a month the resume does not state. For a range like "2016 – 2020", startDate is "2016" and endDate is "2020". For "Present"/"Current", leave endDate out and set isCurrent true (experience only).
