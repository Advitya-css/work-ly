...
export type RateLimitWhereInput = {
  ...
  expires_at?: Prisma.DateTimeFilter<"RateLimit"> | Date | string
}
...
export type RateLimitScalarWhereWithAggregatesInput = {
  ...
  expires_at?: Prisma.DateTimeWithAggregatesFilter<"RateLimit"> | Date | string
}
...
export type RateLimitOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "count" | "expires_at", ExtArgs["result"]["rateLimit"]>
...
export interface RateLimitFieldRefs {
  ...
  readonly expires_at: Prisma.FieldRef<"RateLimit", 'DateTime'>
}
